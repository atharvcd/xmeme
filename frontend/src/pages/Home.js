...
const Home = () => {
  ...
  return (
    <div className = "row" style = {{display : "flex", overflow : "hidden", height : "auto", margin : "1% 3% 1% 2%"}}>
       <div style = {{width : "100%", margin : "0.5% auto 3% auto"}}>
      ...
      <div className = "col-md-8" style = {{float : "left", padding : "0 2% 0 0%"}}>
        <div className = "row" style = {{display : "flex",alignContent : "center", margin : "0.8% auto"}}>
        ...
        <div className="scrollbar scrollbar-primary  mx-auto" style = {{height : "92vh", overflowY : "scroll", overflowX : "hidden", padding : "2.5% 2.5%", backgroundColor : "#1f1f1f", filter : "brightness(100%)"}}>
      ...
      <div className = "col-md-4" style = {{textAlign : "right", width : "100%",height : "100%", padding : "0.5%"}}>
        <div style = {{textAlign : "left",fontSize : "3vw", fontFamily : "Sofia", color : "#ffffff", margin : "1.5% 1%"}}>Trending Creators</div>
        <div className="scrollbar scrollbar-primary  mt-4 mx-auto" style = {{backgroundColor : "#2c2c2c", opacity : "1", height : "92vh", overflowY : "scroll", overflowX : "hidden", padding : "5% 5%"}}>
